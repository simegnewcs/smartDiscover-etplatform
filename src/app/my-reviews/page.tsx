      ...
      <div className="min-h-screen bg-neutral-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-sm border border-neutral-200 p-8 max-w-md w-full text-center">
          <div className="w-16 h-16 bg-[#D1FAE5] rounded-full flex items-center justify-center mx-auto mb-4">
            <Star className="w-8 h-8 text-[#047857]" />
          </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-6">
          ...
          <div className="flex gap-2">
            <select
              ...
              className="px-3 py-2.5 bg-white border border-neutral-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#047857] appearance-none cursor-pointer text-sm"
            >
            ...
            <div className="relative">
              ...
              <select
                ...
                className="pl-10 pr-8 py-2.5 bg-white border border-neutral-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#047857] appearance-none cursor-pointer text-sm"
              >
        ...
        {reviews.length === 0 && (
          <div className="bg-white rounded-2xl shadow-sm border border-neutral-200 p-12 text-center">
            <div className="w-20 h-20 bg-[#D1FAE5] rounded-full flex items-center justify-center mx-auto mb-4">
              <Star className="w-10 h-10 text-[#047857]" />
            </div>
                ...
                <div className="flex flex-col sm:flex-row">
                  ...
                  <div className="sm:w-48 h-32 sm:h-auto bg-neutral-100 flex-shrink-0">
                    {review.business.imageUrl ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-[#D1FAE5] to-[#FBBF24]/30">
                        <Star className="w-8 h-8 text-[#047857]/30" />
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex-1 p-5">
                    <div className="flex items-start justify-between gap-2">
                      <div>
                        <Link href={`/business/${review.business.slug}`}>
                          <h3 className="font-semibold text-neutral-800 hover:text-[#047857] transition-colors">
                    ...
                    <Link
                      ...
                      className="inline-flex items-center gap-1 text-sm text-[#047857] hover:underline mt-3"
                    >
